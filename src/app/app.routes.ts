...
import { DashboardThongKeComponent } from './pages/dashboard-thong-ke/dashboard-thong-ke.component';
...
export const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: 'dashboard-thong-ke' },
  { path: 'dashboard-thong-ke', component: DashboardThongKeComponent },
